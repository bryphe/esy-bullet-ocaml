...
# Compile object file
	...
	x86_64-w64-mingw32-g++ -fno-exceptions -fno-rtti -I$(OCAMLLIB) -IE:/esy-bullet/node_modules/.cache/_esy/store/b/esy_bullet-0.1.0-cdc154d0/bullet3/src -c ./bullet_wrapper.c -o $(BUILDDIR)/bullet_wrapper.o
